import { Agenda, AgendaDisabled } from '@/assets/Agenda';
import { BreakTime, BreakTimeDisabled } from '@/assets/BreakTime';
...
export const AgendaCard = ({
  ...
  return (
    <Wrapper justify="flex-between" isDone={isDone}>
      {type === 'agenda' ? (
        !isDone ? (
          <Agenda width="40" height="40" />
        ) : (
          <AgendaDisabled width="40" height="40" />
        )
      ) : !isDone ? (
        <BreakTime width="40" height="40" />
      ) : (
        <BreakTimeDisabled width="40" height="40" />
      )}
